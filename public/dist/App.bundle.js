...
function loadPlaces(map) {
  ...
  axios__WEBPACK_IMPORTED_MODULE_0___default().get("/api/stores/near?lat=".concat(lat, "&lng=").concat(lng)).then(function (res) {
    ...
    var markers = places.map(function (place) {
      ...
      marker.place = place;
      return marker;
    }); // when someone clicks on a market, show details of place
...
function typeAhead(search) {
  ...
  searchInput.on('input', function () {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default().get("api/search?q=".concat(this.value)).then(function (res) {
      if (res.data.length) {
        searchResult.innerHTML = dompurify__WEBPACK_IMPORTED_MODULE_1___default().sanitize(searchResultsHTML(res.data));
      } else {
        searchResult.innerHTML = dompurify__WEBPACK_IMPORTED_MODULE_1___default().sanitize("\n                        <div class=\"search__result\">No results for ".concat(_this.value, " found!</div>\n                    "));
      }
    }).catch(function (err) {
      console.error(err);
    });
  ...
  searchInput.on('keyup', function (e) {
    ...
    if (e.keyCode === 40 && current) {
      ...
      next = current.previosElementSibling || items[items.length - 1];
...
/* harmony import */ var _autocomplete__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./autocomplete */ "./public/javascripts/autocomplete.js");
...
(0,_autocomplete__WEBPACK_IMPORTED_MODULE_2__["default"])((0,_modules_bling__WEBPACK_IMPORTED_MODULE_1__.$)('#address'), (0,_modules_bling__WEBPACK_IMPORTED_MODULE_1__.$)('#lng'), (0,_modules_bling__WEBPACK_IMPORTED_MODULE_1__.$)('#lat'));
